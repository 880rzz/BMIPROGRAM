...
assert(cfg&&Array.isArray(cfg.programs)&&cfg.programs.length===27,'Schema age validation requires 27 programs.');
...
console.log('PASS: all 27 programs expose hard age ranges in recommendation logic and Schema.');
