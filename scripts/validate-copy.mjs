...
assert(transit.includes('v6.oebb.transport.rest/api')&&transit.includes('/locations/nearby?')&&transit.includes('/journeys?'),'v6 OEBB REST endpoints missing.');
...
console.log('PASS: v6 scheduled transit time/distance, responsive travel UI and existing recommender contracts are consistent.');